...
Original file is located at
    https://colab.research.google.com/drive/1WQawt7lNlO0Xp8Ls5_hwqDnl3ID6xkok
...
submission['TARGET'] = 0.25 * m1['TARGET'] + 0.6 * m2['TARGET'] + 0.15 * m3['TARGET']

submission.to_csv('Elite_Model_1.csv', index = False)
